        ...
        return new WebMvcConfigurer() {
            ...
            public void addCorsMappings(CorsRegistry registry) {
                registry.addMapping("/**")  // Разрешаем все пути
                        .allowedOrigins("http://localhost:8080","http://localhost:5500", "https://adrianocoffee-production.up.railway.app/swagger-ui/index.html#/")  // Разрешаем запросы с определенных доменов
